...
Glob patterns for detecting project structure signals. Run these in parallel using `find_by_name`. Do NOT read file contents — directory/filename presence is the signal.
